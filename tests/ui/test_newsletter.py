...
class TestNewsletter:
    def test_newsletter_registration_footer(self, home_page, page, config, cookie_modal, footer, user_email):
        home_page.goto()
    ...
    def test_newsletter_registration_basket(self, home_page, page, config, cookie_modal, header, footer, user_email):
        home_page.goto()
        expect(page).to_have_url(f"{config['base_url']}{home_page.PATH}")
